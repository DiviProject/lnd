...
`btcd`
------
Ensures that the [`github.com/Divicoin/btcd`][btcd] repository is checked out
locally. Lastly, installs the version of 
[`github.com/Divicoin/btcd`][btcd] specified in `Gopkg.toml`
...
`check`
-------
Installs the version of [`github.com/Divicoin/btcd`][btcd] specified
...
`itest`
-------
Installs the version of [`github.com/Divicoin/btcd`][btcd] specified in
...
[btcd]: https://github.com/Divicoin/btcd (github.com/Divicoin/btcd")
